...
// Data setup steps
Given("there are {int} opened tickets assigned to {string}", async function (this: CustomWorld, count: number, assignee: string) {
...
// Filter steps
When("user filters by assignee {string}", async function (this: CustomWorld, assignee: string) {
...
// Bulk reassign steps
When("user expands {string} section", async function (this: CustomWorld, sectionName: string) {
...
When("user selects {string} from assignee filter", async function (this: CustomWorld, assignee: string) {
...
When("user selects {string} as reassign target", async function (this: CustomWorld, assignee: string) {
...
// Modal steps
When("user changes assignee to {string}", async function (this: CustomWorld, newAssignee: string) {
  const modal = this.page.locator('[data-testid="edit-ticket-modal"], [role="dialog"]').first();
...
// Assertion steps
Then("user should see {string} column in the table", async function (this: CustomWorld, columnName: string) {
  const column = this.page.getByText(columnName, { exact: true });
  await expect(column).toBeVisible({ timeout: 5000 });
});

Then("table should display assignee {string}", async function (this: CustomWorld, assignee: string) {
...
Then("table should show {int} tickets", async function (this: CustomWorld, expectedCount: number) {
  const rows = this.page.locator("tbody tr");
  await expect(rows).toHaveCount(expectedCount, { timeout: 5000 });
});

Then("all displayed tickets should have assignee {string}", async function (this: CustomWorld, assignee: string) {
...
Then("assignee should be updated to {string}", async function (this: CustomWorld, newAssignee: string) {
...
Then("bulk reassign count should show {string}", async function (this: CustomWorld, expectedCount: string) {
...
When("user clicks {string} button", async function (this: CustomWorld, buttonText: string) {
...
Then("user should not see {string} column", async function (this: CustomWorld, columnName: string) {
  const column = this.page.getByText(columnName, { exact: true });
  await expect(column).not.toBeVisible({ timeout: 3000 });
});

Then("user should not see {string} section", async function (this: CustomWorld, sectionName: string) {
  const section = this.page.getByText(sectionName);
