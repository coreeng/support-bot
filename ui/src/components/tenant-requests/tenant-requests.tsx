            ...
            <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200">
                <div className="max-w-[1400px] mx-auto px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-xl font-bold text-slate-900">Tenant Requests</h1>
                        </div>
                            ...
                            {preset === 'custom' && (
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="px-2 py-1.5 text-sm bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300"
                                    />
                                    ...
                                    />
                                    {!isDateRangeValid && (
                                        <span className="text-xs text-red-600 font-medium">Invalid range</span>
                                    )}
                                </div>
                            )}
                        </div>
