...
describe("KnowledgeGapsPage", () => {
  ...
  it("expands individual area to show relevant queries on click", () => {
    ...
    const disclosure = screen
      .getAllByRole("button")
      .find((button) => button.getAttribute("aria-controls") === "support-area:Knowledge Gap-queries");
      ...
      supportAreas: [
        {
          ...
          coveragePercentage: 56,
          queryCount: 12,
          queries: [{ text: "Support area query", timestamp: "2025-03-31T12:34:56Z", ticketId: "401" }],
        },
      ],
      knowledgeGaps: [
        {
          ...
          queryCount: 8,
          queries: [{ text: "Knowledge gap query", timestamp: "2025-03-30T07:08:09Z", ticketId: "402" }],
        },
      ],
    };
      ...
      supportAreas: [
        {
          ...
          queryCount: 1,
          queries: [{ text: "Query with bad timestamp", timestamp: "not-a-date", ticketId: "999" }],
        },
      ],
    };
