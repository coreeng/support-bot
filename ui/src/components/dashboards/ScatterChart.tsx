...
import { CartesianGrid, ScatterChart as RechartsScatter, ResponsiveContainer, Scatter, Tooltip, XAxis, YAxis } from "recharts";
...
export function ScatterChart({ title, data, yAxisLabel = "Minutes", color = "var(--chart-1)", isLoading }: ScatterChartProps) {
  return (
