...
export function ResponseSLASection({
 ...
 <div>
 <h2 className="text-base font-semibold text-foreground">Response Performance</h2>
 <p className="text-sm text-muted-foreground">Track first response times and unattended queries</p>
 </div>
