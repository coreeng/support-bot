...
jest.mock("recharts", () => ({
  ...
  Line: ({ dataKey, stroke, name }: any) => <div data-testid={`line-${dataKey}`} data-stroke={stroke} data-name={name} />,
...
describe("TimeSeriesChart", () => {
  ...
  describe("Rendering", () => {
    it("should render chart title", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="Tickets" />);
  ...
  describe("Customization", () => {
    it("should use custom xAxisDataKey", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="Tickets" xAxisDataKey="time" />);
    ...
    it("should show legend when showLegend is true", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="Tickets" showLegend={true} />);

      expect(screen.getByTestId("legend")).toBeInTheDocument();
    });

    it("should hide legend when showLegend is false", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="Tickets" showLegend={false} />);
  ...
  describe("Data Handling", () => {
    it("should handle empty data array", () => {
      render(<TimeSeriesChart title="Empty Chart" data={[]} lines={mockLines} yAxisLabel="Tickets" />);
    ...
    it("should handle single data point", () => {
      ...
      render(<TimeSeriesChart title="Single Point" data={singlePoint} lines={mockLines} yAxisLabel="Tickets" />);
    ...
    it("should handle large datasets", () => {
      ...
      render(<TimeSeriesChart title="Large Dataset" data={largeData} lines={mockLines} yAxisLabel="Tickets" />);
    ...
    it("should render multiple lines correctly", () => {
      ...
      render(
        <TimeSeriesChart
          ...
          data={[{ week: "2024-W01", opened: 10, closed: 8, escalated: 2, stale: 1 }]}
          lines={fourLines}
          yAxisLabel="Tickets"
        />
      );
  ...
  describe("Y-Axis Label", () => {
    it("should display y-axis label", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="Tickets Count" />);
    ...
    it("should handle empty y-axis label", () => {
      render(<TimeSeriesChart title="Test Chart" data={mockData} lines={mockLines} yAxisLabel="" />);
