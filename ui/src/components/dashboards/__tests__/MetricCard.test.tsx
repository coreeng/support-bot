...
describe("MetricCard", () => {
  describe("Rendering", () => {
    ...
    it("should render description when provided", () => {
      render(<MetricCard title="Test Metric" value={42} description="This is a helpful description" />);
  ...
  describe("Color Schemes", () => {
    const valueClassFor = (colorScheme: "blue" | "orange" | "green" | "purple" | "cyan" | "red"): string => {
      const { container } = render(<MetricCard title="Test" value={42} colorScheme={colorScheme} />);
  ...
  describe("Icon", () => {
    it("renders the icon when provided", () => {
      render(<MetricCard title="Test" value={42} icon={<span data-testid="metric-icon" />} />);
