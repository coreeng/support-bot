...
jest.mock("../RefreshButton", () => ({
  RefreshButton: ({ onRefresh, isRefreshing }: any) => (
    <button data-testid="refresh-button" onClick={onRefresh} disabled={isRefreshing}>
...
describe("WeeklyTrendsSection", () => {
  ...
  describe("Percentage Calculations", () => {
    ...
    it("should handle zero last week correctly", () => {
      const comparisonWithZero = [{ label: "opened", thisWeek: 5, lastWeek: 0, change: 5 }];
    ...
    it("should handle zero change correctly", () => {
      const comparisonWithNoChange = [{ label: "stale", thisWeek: 1, lastWeek: 1, change: 0 }];
  ...
  describe("Data Integrity", () => {
    it("should handle single week of data", () => {
      const singleWeek = [{ week: "2024-01-01", opened: 10, closed: 8, escalated: 2, stale: 1 }];
