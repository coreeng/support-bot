...
public class SlackMessage {
    ...
    public Stub expectReactionAdded(String description, String reaction) {
        return slackWiremock.stubReactionAdd(ReactionAddedExpectation.builder()
    ...
    public StubWithResult<TicketMessage> expectThreadMessagePosted(
            ThreadMessagePostedExpectation<TicketMessage> expectation) {
        return slackWiremock.stubMessagePosted(
                expectation.toBuilder().threadTs(ts).channelId(channelId).build());
    }
    ...
    public TicketCreationFlowStubs stubTicketCreationFlow(
            String reason, MessageTs newTicketMessageTs, @Nullable MessageTs replyTs) {
        ...
        StubWithResult<TicketMessage> posted =
    ...
    public record TicketCreationFlowStubs(
            Stub conversationsReplies, Stub reactionAdded, StubWithResult<TicketMessage> ticketMessagePosted) {
