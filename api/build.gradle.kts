...
val safeDependencyVersions =
    mapOf(
        ...
        "io.netty:netty-codec-http2" to "4.1.137.Final",
        "io.netty:netty-common" to "4.1.137.Final",
        "io.netty:netty-handler" to "4.1.137.Final",
        "io.netty:netty-handler-proxy" to "4.1.137.Final",
        "io.netty:netty-resolver-dns" to "4.1.137.Final",
