...
public class SupportTeamConfig {
    ...
    @Bean
    @Qualifier("supportTeamFetcher") @ConditionalOnProperty(value = "team.support.static.enabled", havingValue = "false", matchIfMissing = true)
    ...
    @Bean
    @Qualifier("leadershipTeamFetcher") @ConditionalOnProperty(value = "team.leadership.static.enabled", havingValue = "false", matchIfMissing = true)
    public TeamMemberFetcher leadershipTeamFetcher(SlackClient slackClient, ExecutorService executor) {
        return new GenericSlackMemberFetcher(slackClient, executor);
    }

    @Bean
    @Qualifier("supportTeamFetcher") @ConditionalOnProperty("team.support.static.enabled")
    ...
    @Bean
    @Qualifier("leadershipTeamFetcher") @ConditionalOnProperty("team.leadership.static.enabled")
