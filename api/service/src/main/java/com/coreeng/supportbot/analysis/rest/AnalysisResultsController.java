...
public class AnalysisResultsController {
    ...
    public AnalysisUI getAnalysis() {
        List<DimensionSummaryUI> knowledgeGaps =
                dimensionMapper.mapToUI(analysisResultsService.getKnowledgeGapCategoriesWithSummaries());

        List<DimensionSummaryUI> supportAreas =
                dimensionMapper.mapToUI(analysisResultsService.getDriversWithSummaries());
