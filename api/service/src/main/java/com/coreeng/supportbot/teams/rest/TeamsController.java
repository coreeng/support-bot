...
public class TeamsController {
    ...
    @GetMapping
    public ImmutableList<TeamUI> listTeams(@Nullable @RequestParam(name = "type", required = false) TeamType type) {
        ...
        return teams.stream().map(mapper::mapToUI).collect(toImmutableList());
    }
}
