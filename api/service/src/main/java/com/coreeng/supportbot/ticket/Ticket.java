...
public class Ticket {
    ...
    @Nullable private TicketTeam team;
    ...
    public static Ticket createNew(MessageTs queryTs, String channelId) {
        return Ticket.builder()
                ...
                .statusLog(ImmutableList.of(new StatusLog(TicketStatus.opened, Instant.now())))
    ...
    public record StatusLog(TicketStatus status, Instant date) {}
}
