...
class SupportTeamServiceTest {
    ...
    void initLoadsSupportAndLeadershipMembers() {
        ImmutableList<TeamMemberFetcher.TeamMember> supportMembers =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("a@c.com", SlackId.user("U1")));
        ImmutableList<TeamMemberFetcher.TeamMember> leadershipMembers =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("b@c.com", SlackId.user("U2")));
        when(supportMemberFetcher.loadInitialMembers(SlackId.group("SUPPORT_ID")))
                .thenReturn(supportMembers);
        when(leadershipMemberFetcher.loadInitialMembers(SlackId.group("LEADERSHIP_ID")))
                .thenReturn(leadershipMembers);
    ...
    void isMemberChecksCaseInsensitive() {
        when(supportMemberFetcher.loadInitialMembers(SlackId.group("SUPPORT_ID")))
                .thenReturn(ImmutableList.of(new TeamMemberFetcher.TeamMember("USER@c.com", SlackId.user("U1"))));
        when(leadershipMemberFetcher.loadInitialMembers(SlackId.group("LEADERSHIP_ID")))
    ...
    void isLeadershipMemberChecksCaseInsensitive() {
        when(supportMemberFetcher.loadInitialMembers(SlackId.group("SUPPORT_ID")))
                .thenReturn(ImmutableList.of());
        when(leadershipMemberFetcher.loadInitialMembers(SlackId.group("LEADERSHIP_ID")))
                .thenReturn(ImmutableList.of(new TeamMemberFetcher.TeamMember("LEAD@c.com", SlackId.user("U2"))));
    ...
    void handleSupportMembershipUpdateUpdatesWhenNonEmpty() {
        ImmutableList<TeamMemberFetcher.TeamMember> updated =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("x@y.com", SlackId.user("UX")));
        when(supportMemberFetcher.handleMembershipUpdate(
                        SlackId.group("SUPPORT_ID"), ImmutableList.of(SlackId.user("u1"))))
                .thenReturn(updated);
    ...
    void handleSupportMembershipUpdateIgnoresEmptyResults() {
        ImmutableList<TeamMemberFetcher.TeamMember> initial =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("keep@y.com", SlackId.user("UO")));
        when(supportMemberFetcher.loadInitialMembers(SlackId.group("SUPPORT_ID")))
                .thenReturn(initial);
        when(leadershipMemberFetcher.loadInitialMembers(SlackId.group("LEADERSHIP_ID")))
                .thenReturn(ImmutableList.of());
    ...
    void handleLeadershipMembershipUpdateUpdatesWhenNonEmpty() {
        ImmutableList<TeamMemberFetcher.TeamMember> updated =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("lead@y.com", SlackId.user("UL")));
        when(leadershipMemberFetcher.handleMembershipUpdate(
                        SlackId.group("LEADERSHIP_ID"), ImmutableList.of(SlackId.user("u2"))))
                .thenReturn(updated);
    ...
    void handleLeadershipMembershipUpdateIgnoresEmptyResults() {
        ImmutableList<TeamMemberFetcher.TeamMember> initial =
                ImmutableList.of(new TeamMemberFetcher.TeamMember("keep@y.com", SlackId.user("UL")));
        when(supportMemberFetcher.loadInitialMembers(SlackId.group("SUPPORT_ID")))
                .thenReturn(ImmutableList.of());
        when(leadershipMemberFetcher.loadInitialMembers(SlackId.group("LEADERSHIP_ID")))
                .thenReturn(initial);
