...
Review the supplied change context: changed files, changed modules, module guidance, relevant ADRs, and other repository evidence. Use that context to check whether high-risk changes are necessary for the rest of the change and whether their blast radius is justified.
